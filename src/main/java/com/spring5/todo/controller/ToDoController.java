package com.spring5.todo.controller;

import com.spring5.todo.model.ToDo;
import com.spring5.todo.repository.ToDoRepository;
...
public class ToDoController {
	...
	public ResponseEntity<Iterable<ToDo>> getToDos(@RequestHeader HttpHeaders headers) {
		return new ResponseEntity<Iterable<ToDo>>(this.repository.findAll(), headers, HttpStatus.OK);//content negotiation
	}
}